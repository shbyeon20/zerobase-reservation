...
import com.zerobase.zerobasereservation.reservation.dto.CreateReview;
import com.zerobase.zerobasereservation.reservation.dto.DeleteReview;
import com.zerobase.zerobasereservation.reservation.dto.ReviewDto;
import com.zerobase.zerobasereservation.reservation.dto.UpdateReview;
import com.zerobase.zerobasereservation.reservation.service.ReviewService;
...
public class ReviewController {
    ...
    public ResponseEntity<UpdateReview.Response> updateReview(
        ...
        log.info("Review update request received for reviewId: {}",
            request.getReviewId());
    ...
    public ResponseEntity<DeleteReview.Response> deleteReview(
        ...
        log.info("Delete request received for reviewId: {}",
            request.getReviewId());
